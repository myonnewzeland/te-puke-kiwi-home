      ...
      <section className="section-padding">
        <div className="container-narrow max-w-3xl">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground opacity-0 animate-fade-in-up [animation-delay:200ms]">
              Whether you're a seasonal worker, backpacker or RSE employer — get in touch to book your stay. Contact us directly using the details below.
            </p>
          </div>

          <div className="space-y-8 opacity-0 animate-fade-in-up [animation-delay:300ms]">
